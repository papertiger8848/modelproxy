...
ModelProxy.init = function( path, variables ) {
    ...
    //     }
    ProxyFactory.use( new InterfaceManager( path, variables ) );
    // }
...
// special code for modelproxy init
// function init() {
//     var global = require( 'midway-global' );
//     var conf = global.getConfig();
//     var path = conf.modelproxy.path;
//     ProxyFactory.use( new InterfaceManager( path, conf ) );
...
//     init();
// } catch ( e ) {
//     logger.warn( 'Can not initialize ModelProxy from global configuration. You must initialize it manually.' );
// }
